...
<head>
    ...
    <!--[if !IE]> -->
    <script src="js/index/adminMes.js"></script>
        ...
        <div class="d_Confirm_Order_style">
            <div class="search_style">
                ...
                <ul class="search_content clearfix">
                    <li><label class="l_f">用户名称</label><input name="" type="text"  class="text_add" placeholder="输入用户ID" id="mid" style=" width:400px"/></li>
                    <li style="width:90px;"><button type="button" class="btn_search" id="m_search"><i class="icon-search"></i>查询</button></li>
                </ul>
            </div>
            <!---->
            ...
            <span style="font-size: 10px; float: left; line-height:30px">共<span id="count"></span>条记录</span>
<%--            第<span id="page_num">1</span>页,--%>
