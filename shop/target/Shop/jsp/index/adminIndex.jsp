...
<%--<!--    <link rel="stylesheet" href="adminresource/assets/css/font-awesome-ie7.min.css" />-->--%>
    ...
    <link rel="stylesheet" href="adminresource/assets/css/ace-rtl.min.css" />
    <link rel="stylesheet" href="adminresource/assets/css/ace-skins.min.css" />
...
<!--    <link rel="stylesheet" href="adminresource/assets/css/ace-ie.min.css" />-->
    ...
    <script src="js/index/adminIndex.js"></script>
    <!-- <![endif]-->
    <!--[if IE]>
    <script type="text/javascript">window.jQuery || document.write("<script src='adminresource/assets/js/jquery-1.10.2.min.js'>"+"<"+"script>");</script>
    <![endif]-->
    ...
    <!--[if lte IE 8]>
    <script src="adminresource/assets/js/excanvas.min.js"></script>
    <![endif]-->
    ...
    <script src="adminresource/js/jquery.nicescroll.js" type="text/javascript"></script>
    ...
    <div class="navbar-container" id="navbar-container">
        <div class="navbar-header pull-left">
            <a href="#" class="navbar-brand">
                <small>
                    <img src="adminresource/images/logo.png" width="470px" onclick="location.href='https://shop68701876.taobao.com/?spm=a211vu.server-home.sellercard.15.49965e16btRrif'">
                </small>
            </a><!-- /.brand -->
        </div><!-- /.navbar-header -->
        ...
        <div class="sidebar" id="sidebar">
            ...
            <div id="menu_style" class="menu_style">
                <ul class="nav nav-list" id="nav_list">
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text">类别管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="admincategory.jsp" title="类别列表"  class="iframeurl"><i class="icon-double-angle-right"></i>类别列表</a></li>
                            <!-- <li class="home"><a href="javascript:void(0)" name="member-Grading.html" title="等级管理"  class="iframeurl"><i class="icon-double-angle-right"></i>等级管理</a></li>
                             <li class="home"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
                             -->
                        </ul>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text">商品管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="adminproduct.jsp" title="商品列表"  class="iframeurl"><i class="icon-double-angle-right"></i>商品列表</a></li>
                            <!-- <li class="home"><a href="javascript:void(0)" name="member-Grading.html" title="等级管理"  class="iframeurl"><i class="icon-double-angle-right"></i>等级管理</a></li>
                             <li class="home"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
                             -->
                        </ul>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text">订单管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="adminorder.jsp" title="订单列表"  class="iframeurl"><i class="icon-double-angle-right"></i>订单列表</a></li>
                            <!-- <li class="home"><a href="javascript:void(0)" name="member-Grading.html" title="等级管理"  class="iframeurl"><i class="icon-double-angle-right"></i>等级管理</a></li>
                             <li class="home"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
                             -->
                        </ul>
                    ...
                    <li>
                        <a href="#" class="dropdown-toggle"><i class="icon-user"></i><span class="menu-text">留言管理 </span><b class="arrow icon-angle-down"></b></a>
                        <ul class="submenu">
                            <li class="home"><a href="javascript:void(0)" name="adminMes.jsp" title="留言列表"  class="iframeurl"><i class="icon-double-angle-right"></i>留言列表</a></li>
                            <!-- <li class="home"><a href="javascript:void(0)" name="member-Grading.html" title="等级管理"  class="iframeurl"><i class="icon-double-angle-right"></i>等级管理</a></li>
                             <li class="home"><a href="javascript:void(0)" name="integration.html" title="会员记录管理"  class="iframeurl"><i class="icon-double-angle-right"></i>会员记录管理</a></li>
                             -->
                        </ul>
