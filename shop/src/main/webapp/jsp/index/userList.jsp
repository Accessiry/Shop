...
<head>
  ...
  <link rel="stylesheet" href="${pageContext.request.contextPath}/jsp/index/adminresource/css/style.css"/>
    ...
    <div class="d_Confirm_Order_style">
      <div class="search_style">
        ...
        <ul class="search_content clearfix">
          <li><label class="l_f">会员名称</label><input name="" type="text"  class="text_add" placeholder="输入会员用户名" id="mname" style=" width:400px"/></li>
